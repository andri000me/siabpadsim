...
<section id="services" class="services">
      ...
      <ol class="breadcrumb" >
        ...
        <li class="breadcrumb-item active">Update Nomor Surat Perintah Pengiriman</li>
      </ol>
...
<div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-plus"></i> Update Nomor Surat Perintah Pengiriman</div>
        <div class="card-body">
          <div class="table-responsive">
             <div class="container">

        <form action="<?php echo base_url('suratperintahpengiriman/simpan_update')?>" method="post" enctype="multipart/form-data">
        <input type="hidden" name="id_faktur"  value="<?php echo $ambil->id_faktur; ?>" />
        <div class="form-group">
              <div class="form-row">
              <div class="col-md-6">
                    <label for="no_suratperintahpengiriman">No Surat Perintah Pengiriman</label>
                    <input value="<?php echo $ambil->no_suratperintahpengiriman; ?>"class="form-control" id="no_suratperintahpengiriman" type="text" aria-describedby="nameHelp" name="no_suratperintahpengiriman" required/>
                  </div>
                 </div>
