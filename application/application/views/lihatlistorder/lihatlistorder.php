...
<section id="services" class="services">
 ...
 <a href="<?php echo base_url()?>permintaanpengadaanbarang/updatesetuju/<?php echo $hasilparsing; ?>" class="btn btn-primary" style="margin-bottom: 10px;"><i class="fa fa-plus">Setuju</a></i>
 <a href="<?php echo base_url()?>permintaanpengadaanbarang/updatetolak/<?php echo $hasilparsing; ?>" class="btn btn-danger" style="margin-bottom: 10px;"><i class="fa fa-plus">Tolak</a></i>
