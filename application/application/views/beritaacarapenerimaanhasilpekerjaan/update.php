...
<section id="services" class="services">
      ...
      <ol class="breadcrumb" >
        ...
        <li class="breadcrumb-item active">Update Nomor Berita Acara Penerimaan Hasil Pekerjaan</li>
      </ol>
...
<div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-plus"></i> Update Nomor Berita Acara Penerimaan Hasil Pekerjaan</div>
        <div class="card-body">
          <div class="table-responsive">
             <div class="container">

        <form action="<?php echo base_url('beritaacarapenerimaanhasilpekerjaan/simpan_update')?>" method="post" enctype="multipart/form-data">
        <input type="hidden" name="id_faktur"  value="<?php echo $ambil->id_faktur; ?>" />
        <div class="form-group">
              <div class="form-row">
              <div class="col-md-6">
                    <label for="no_beritaacaraphp">No Berita Acara Penerimaan Hasil Pekerjaan</label>
                    <input value="<?php echo $ambil->no_beritaacaraphp; ?>"class="form-control" id="no_beritaacaraphp" type="text" aria-describedby="nameHelp" name="no_beritaacaraphp" required/>
                  </div>
                 </div>
