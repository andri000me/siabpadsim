...
<section id="services" class="services">
      ...
      <ol class="breadcrumb" >
        ...
        <li class="breadcrumb-item active">Update Nomor Surat</li>
      </ol>
...
<div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-plus"></i> Update Nomor Berita Acara Penyaluran Barang</div>
        <div class="card-body">
          <div class="table-responsive">
             <div class="container">

        <form action="<?php echo base_url('buktipenyaluranbarang/simpan_update')?>" method="post" enctype="multipart/form-data">
        <input type="hidden" name="id_penyaluran"  value="<?php echo $ambil->id_penyaluran; ?>" />
        <div class="form-group">
              <div class="form-row">
              <div class="col-md-6">
                    <label for="no_beritaacarapb">Nomor Berita Acara Penyaluran Barang</label>
