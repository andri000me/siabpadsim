...
<section id="services" class="services">
      ...
      <ol class="breadcrumb" >
        ...
        <li class="breadcrumb-item active">Manajemen Rekanan</li>
      </ol>
 <a href="<?php echo base_url('rekanan/tambah')?>" class="btn btn-primary" style="margin-bottom: 10px;"><i class="fa fa-plus">Tambah Data</a></i>
     
 <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Daftar Tabel Rekanan</div>
        ...
        <div class="card-body">
          ...
          <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?php echo $no;?></td>
                        <td><?php echo $item->nama_pimpinan;?></td>
                        <td><?php echo $item->nama_rekanan;?></td>
                        <td><?php echo $item->alamat_rekanan;?></td>
                        <td> <a href="<?php echo base_url()?>rekanan/update/<?php echo $item->id_rekanan; ?>" class="btn btn-warning" role="button">Update</a></td>
                        <td> <a href="<?php echo base_url()?>rekanan/hapus/<?php echo $item->id_rekanan; ?>" onclick="return confirm('Apakah anda yakin?');"class="btn btn-danger" role="button">Delete</a></td>
                    </tr>
                    <?php
                            $no++;
                    }
