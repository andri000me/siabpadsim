          ...
          <table class="table table-bordered">
                <thead>
                    ...
                    <th>No</th> 
                        ...
                        <th>Rekanan</th>
                        <th>Keterangan</th> 
                        <th>No Surat Perintah Pengiriman</th> 
                ...
                <tbody>
                    ...
                    <td><?php echo $no;?></td>
                        ...
                        <td> <a href="<?php echo base_url()?>suratperintahpengiriman/update/<?php echo $item->id_faktur; ?>" class="btn btn-warning" role="button">Update</a></td>
                        <td> <a href="<?php echo base_url()?>suratperintahpengiriman/print/<?php echo $item->id_faktur; ?>" class="btn btn-warning" role="button">Print</a></td>
                    </tr>
                    <?php
                            $no++;
                    }
