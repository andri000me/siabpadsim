...
<section id="services" class="services">
      ...
      <ol class="breadcrumb" >
        ...
        <li class="breadcrumb-item active">Daftar Tabel Ditolak</li>
      </ol>
     
 <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Daftar Tabel Ditolak </div>
          ...
          <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> <a href="<?php echo base_url()?>permintaanpenyaluranbarang/updatesetuju/<?php echo $item->id_penyaluran; ?>" onclick="return confirm('Apakah anda yakin?');" class="btn btn-warning" role="button">Setuju</a></td>
                    </tr>
                    <?php
                            $no++;
                    }
