...
<section id="services" class="services">
      ...
      <ol class="breadcrumb" >
        ...
        <li class="breadcrumb-item active">Daftar Tabel Faktur</li>
      </ol>

 <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Daftar Tabel Faktur</li>
      </ol> </div>
          ...
          <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <td><?php echo $no;?></td>
                        ...
                        <td> <a href="<?php echo base_url()?>faktur/update/<?php echo $item->id_faktur; ?>" class="btn btn-warning" role="button">Update</a></td>
                        <td> <a href="<?php echo base_url()?>faktur/print/<?php echo $item->id_faktur; ?>" class="btn btn-warning" role="button">Print</a></td>
                    </tr>
                    <?php
                            $no++;
                    }
