          ...
          <table class="table table-bordered" id="example" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="center"> <a href="<?php echo base_url()?>detailpengadaan/update/<?php echo $item->id_detailpengadaan;?>/<?php echo $hasilparsing?>" class="btn btn-warning" role="button">Update</a></td>
                        <td align="center"> <a href="<?php echo base_url()?>detailpengadaan/hapus/<?php echo $item->id_detailpengadaan;?>/<?php echo $hasilparsing?>" onclick="return confirm('Apakah anda yakin?');"class="btn btn-danger" role="button">Delete</a></td>
                    </tr>
                    <?php
                            $no++;
                    }
