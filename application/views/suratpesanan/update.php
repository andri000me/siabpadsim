...
<section id="services" class="services">
      ...
      <ol class="breadcrumb" >
        ...
        <li class="breadcrumb-item active">Update Nomor Surat Pesanan</li>
      </ol>
...
<div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-plus"></i> Update Nomor Surat Pesanan</div>
        <div class="card-body">
          <div class="table-responsive">
             <div class="container">

        <form action="<?php echo base_url('suratpesanan/simpan_update')?>" method="post" enctype="multipart/form-data">
        <input type="hidden" name="id_faktur"  value="<?php echo $ambil->id_faktur; ?>" />
        <div class="form-group">
              <div class="form-row">
              <div class="col-md-6">
                    <label for="no_suratpesanan">No Surat</label>
                    <input value="<?php echo $ambil->no_suratpesanan; ?>"class="form-control" id="no_suratpesanan" type="text" aria-describedby="nameHelp" name="no_suratpesanan" required/>
                  </div>
                 </div>
