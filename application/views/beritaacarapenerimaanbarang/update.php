...
<section id="services" class="services">
      ...
      <ol class="breadcrumb" >
        ...
        <li class="breadcrumb-item active">Update Nomor Berita Acara Penerimaan Barang</li>
      </ol>
...
<div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-plus"></i> Update Nomor Berita Acara Penerimaan Barang</div>
        <div class="card-body">
          <div class="table-responsive">
             <div class="container">

        <form action="<?php echo base_url('beritaacarapenerimaanbarang/simpan_update')?>" method="post" enctype="multipart/form-data">
        <input type="hidden" name="id_faktur"  value="<?php echo $ambil->id_faktur; ?>" />
        <div class="form-group">
              <div class="form-row">
              <div class="col-md-6">
                    <label for="no_beritaacarapenerimaanbarang">No Berita Acara Penerimaan Barang</label>
                    <input value="<?php echo $ambil->no_beritaacarapb; ?>"class="form-control" id="no_beritaacarapb" type="text" aria-describedby="nameHelp" name="no_beritaacarapb" required/>
                  </div>
                 </div>
                 <div class="col-md-6">
                    <label for="tanggalterimabarang">Tanggal Terima Barang</label>
                    <input value="<?php echo $ambil->tanggalterimabarang; ?>"class="form-control" id="tanggalterimabarang" type="date" aria-describedby="nameHelp" name="tanggalterimabarang" required/>
                  </div>
                 </div>
              <div class="form-group">
            <div class="form-row">
