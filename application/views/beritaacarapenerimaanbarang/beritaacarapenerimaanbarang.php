...
<section id="services" class="services">
      ...
      <ol class="breadcrumb" >
        ...
        <li class="breadcrumb-item active">Daftar Tabel Berita Acara Penerimaan Barang</li>
      </ol>

 <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Daftar Tabel Berita Acara Penerimaan Barang</li>
      </ol> </div>
        ...
        <div class="card-body">
          ...
          <table class="table table-bordered">
                <thead>
                    ...
                    <th>No</th> 
                        <th>Rekanan</th>
                        <th>No Berita Acara Penerimaan Barang</th> 
                ...
                <tbody>
                    ...
                    <td><?php echo $no;?></td>
                        ...
                        <td> <a href="<?php echo base_url()?>beritaacarapenerimaanbarang/update/<?php echo $item->id_faktur; ?>" class="btn btn-warning" role="button">Update</a></td>
                        <td> <a href="<?php echo base_url()?>beritaacarapenerimaanbarang/print/<?php echo $item->id_faktur; ?>" class="btn btn-warning" role="button">Print</a></td>
                    </tr>
                    <?php
                            $no++;
                    }
