<!-- ======= Services Section ======= -->
    <section id="services" class="services">
      ...
      <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up">
          ...
          <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up">
            <div class="icon"><i class="icofont-computer"></i></div>
            <h4 class="title"><a href="<?php echo base_url('sppb'); ?>">Surat Perintah Penyaluran Barang</a></h4>
           </div>
           <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up">
            <div class="icon"><i class="icofont-computer"></i></div>
            <h4 class="title"><a href="<?php echo base_url('buktipenyaluranbarang'); ?>">Bukti Penyaluran Barang</a></h4>
           </div>
