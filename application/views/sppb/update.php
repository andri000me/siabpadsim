...
<div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-plus"></i> Update Nomor Surat</div>
        <div class="card-body">
          <div class="table-responsive">
             <div class="container">

        <form action="<?php echo base_url('sppb/simpan_update')?>" method="post" enctype="multipart/form-data">
        <input type="hidden" name="id_penyaluran"  value="<?php echo $ambil->id_penyaluran; ?>" />
        <div class="form-group">
              <div class="form-row">
              <div class="col-md-6">
                    <label for="no_sppb">No Surat</label>
                    <input value="<?php echo $ambil->no_sppb; ?>"class="form-control" id="no_sppb" type="text" aria-describedby="nameHelp" name="no_sppb" required/>
                  </div>
                 </div>
