...
<section id="services" class="services">
      ...
      <ol class="breadcrumb" >
        ...
        <li class="breadcrumb-item active">Update Nomor Kwitansi</li>
      </ol>
...
<div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-plus"></i> Update Nomor Kwitansi</div>
        <div class="card-body">
          <div class="table-responsive">
             <div class="container">

        <form action="<?php echo base_url('kwitansi/simpan_update')?>" method="post" enctype="multipart/form-data">
        <input type="hidden" name="id_faktur"  value="<?php echo $ambil->id_faktur; ?>" />
        <div class="form-group">
              <div class="form-row">
              <div class="col-md-6">
                    <label for="no_kwitansi">No Kwitansi</label>
                    <input value="<?php echo $ambil->no_kwitansi; ?>"class="form-control" id="no_kwitansi" type="text" aria-describedby="nameHelp" name="no_kwitansi" required/>
                  </div>
                 </div>
