      ...
      <nav class="nav-menu float-right d-none d-lg-block">
        <ul>
          ...
          <li class="drop-down"><a href="">Menu</a>
            <ul>
              <li><a href="<?php echo base_url('pengurusbarangpengguna/asettetap')?>">Aset Tetap</a>
              </li>
              <li><a href="<?php echo base_url('pengurusbarangpengguna/barangpersediaan')?>">Barang Persediaan</a>
              </li>
