...
<section id="services" class="services">
      ...
      <ol class="breadcrumb" >
        <li class="breadcrumb-item">
          <a href="<?php echo base_url('penyaluranPBP')?>">Penyaluran</a>
        </li>
  
        <li class="breadcrumb-item active">Data Penyaluran</li>
      </ol>
          ...
          <table class="table table-bordered" id="example" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="right"><?= 'Rp'.number_format(($item->total_barang_out)*($item->Hargasatuan_ssh),0,'.','.');?></td> </tr>
                    <?php
                            $no++;
                    }
                    ?>
