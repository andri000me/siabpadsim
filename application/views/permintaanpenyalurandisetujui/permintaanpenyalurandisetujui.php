...
<section id="services" class="services">
      ...
      <ol class="breadcrumb" >
        ...
        <li class="breadcrumb-item active">Daftar Tabel  Disetujui</li>
      </ol>
     
 <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Daftar Tabel  Disetujui </div>
          ...
          <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> <a href="<?php echo base_url()?>permintaanpenyaluranbarang/updatetolak/<?php echo $item->id_penyaluran; ?>" onclick="return confirm('Apakah anda yakin?');"class="btn btn-danger" role="button">Tolak</a></td>
                    </tr>
                    <?php
                            $no++;
                    }
