...
<div class="card mb-3">
        ...
        <form action="<?php echo base_url()?>listorderrekanan/simpan_update/<?php echo $hasilparsing; ?>/<?php echo $ambil->id_orderrekanan; ?>" method="post" enctype="multipart/form-data">
