...
<div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-plus"></i> Laporan Pengeluaran</div>
        <div class="card-body">
          <div class="table-responsive">
             <div class="container">
        <form action="<?php echo base_url()?>laporanpengeluaranbarangpersediaan/print/" method="post" enctype="multipart/form-data">
