...
<div class="card mb-3">
        ...
        <form action="<?php echo base_url('datakibb/action_menambahdatadatakibb')?>" method="post" enctype="multipart/form-data">
              ...
              <div class="form-row">
                  ...
                  <div class="col-md-6">
                    <label for="berlaku_sampai">STNK Berlaku Sampai</label>
                    <input class="form-control" id="berlaku_sampai" type="date" aria-describedby="nameHelp" name="berlaku_sampai" required/>
                  </div>
