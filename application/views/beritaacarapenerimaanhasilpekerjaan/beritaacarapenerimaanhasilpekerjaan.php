...
<section id="services" class="services">
      ...
      <ol class="breadcrumb" >
        ...
        <li class="breadcrumb-item active">Daftar Tabel Berita Acara Penerimaan Hasil Pekerjaan</li>
      </ol>

 <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Daftar Tabel Berita Acara Penerimaan Hasil Pekerjaan</li>
      </ol> </div>
          ...
          <table class="table table-bordered">
                <thead>
                    ...
                    <th>No</th> 
                        ...
                        <th>Rekanan</th>
                        <th>Keterangan</th> 
                        <th>No Berita Acara Penerimaan Hasil Pekerjaan</th> 
                ...
                <tbody>
                    ...
                    <td><?php echo $no;?></td>
                        ...
                        <td><?php echo $item->no_beritaacaraphp;?></td>
                        <td> <a href="<?php echo base_url()?>beritaacarapenerimaanhasilpekerjaan/update/<?php echo $item->id_faktur; ?>" class="btn btn-warning" role="button">Update</a></td>
                        <td> <a href="<?php echo base_url()?>beritaacarapenerimaanhasilpekerjaan/print/<?php echo $item->id_faktur; ?>" class="btn btn-warning" role="button">Print</a></td>
                    </tr>
                    <?php
                            $no++;
                    }
