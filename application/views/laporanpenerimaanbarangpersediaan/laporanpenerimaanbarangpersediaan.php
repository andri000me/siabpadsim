...
<section id="services" class="services">
      ...
      <ol class="breadcrumb" >
        ...
        <li class="breadcrumb-item active">Daftar Penerimaan Barang Persediaan</li>
      </ol>

 <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Daftar Penerimaan Barang Persediaan</li>
      </ol> </div>
          ...
          <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <td><?php echo $no;?></td>
                        ...
                        <td> <a href="<?php echo base_url()?>laporanpenerimaanbarangpersediaan/print/<?php echo $item->tahun_pesan; ?>" class="btn btn-warning" role="button">Print</a></td>
                    </tr>
                    <?php
                            $no++;
                    }
